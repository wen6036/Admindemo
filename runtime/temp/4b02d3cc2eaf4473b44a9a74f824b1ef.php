<?php /*a:9:{s:77:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\goods\index.html";i:1567736791;s:77:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\base.html";i:1567736791;s:81:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\head_css.html";i:1567736791;s:80:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\head_js.html";i:1567736791;s:79:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\header.html";i:1567736791;s:80:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\sidebar.html";i:1567736791;s:87:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\content_header.html";i:1567736791;s:79:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\footer.html";i:1567736791;s:88:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\control_sidebar.html";i:1567736791;}*/ ?>
<?php if(!$admin['pjax']): ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                    ...
                    <form class="form-inline searchForm" id="searchForm" action="<?php echo url('index'); ?>" method="GET">
                        ...
                        <div class="form-group">
                            <select name="_order" id="_order" class="form-control input-sm index-order">
                                ...
                                <option value="origin_price" <?php if(isset($_order) &&
                                        $_order=='origin_price'): ?>selected<?php endif; ?>>原价
                                </option>
                                <option value="price" <?php if(isset($_order) && $_order=='price'): ?>selected<?php endif; ?>>售价</option>
                                <option value="weight" <?php if(isset($_order) && $_order=='weight'): ?>selected<?php endif; ?>>重量</option>
                                <option value="stock" <?php if(isset($_order) && $_order=='stock'): ?>selected<?php endif; ?>>库存</option>
                                <option value="sort_number" <?php if(isset($_order) && $_order=='sort_number'): ?>selected<?php endif; ?>>
                                    排序(升序
                                </option>
                                <option value="status" <?php if(isset($_order) && $_order=='status'): ?>selected<?php endif; ?>>是否上架
                                </option>
                            </select>
                        </div>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td><img class="dataListImg" src="<?php echo htmlentities($item['img']); ?>"></td>
                            <td><?php echo htmlentities($item['name']); ?></td>
                            <td><?php echo htmlentities((isset($item['goods_category']['name']) && ($item['goods_category']['name'] !== '')?$item['goods_category']['name']:'')); ?></td>
                            <td><?php echo htmlentities((isset($item['brand']['name']) && ($item['brand']['name'] !== '')?$item['brand']['name']:'')); ?></td>
                            <td><?php echo htmlentities($item['origin_price']); ?></td>
                            <td><?php echo htmlentities($item['price']); ?></td>
                            <td><?php echo htmlentities($item['weight']); ?></td>
