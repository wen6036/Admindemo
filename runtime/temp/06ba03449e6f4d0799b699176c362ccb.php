<?php /*a:9:{s:79:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\article\index.html";i:1567736791;s:77:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\base.html";i:1567736791;s:81:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\head_css.html";i:1567736791;s:80:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\head_js.html";i:1567736791;s:79:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\header.html";i:1567736791;s:80:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\sidebar.html";i:1567736791;s:87:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\content_header.html";i:1567736791;s:79:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\footer.html";i:1567736791;s:88:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\control_sidebar.html";i:1567736791;}*/ ?>
<?php if(!$admin['pjax']): ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                    ...
                    <form class="form-inline searchForm" id="searchForm" action="<?php echo url('index'); ?>" method="GET">
                        ...
                        <div class="form-group">
                            <select name="_order" id="_order" class="form-control input-sm index-order">
                                ...
                                <option value="is_top" <?php if(isset($_order) && $_order=='is_top'): ?>selected<?php endif; ?>>是否置顶
                                </option>
                                <option value="is_hot" <?php if(isset($_order) && $_order=='is_hot'): ?>selected<?php endif; ?>>是否热门
                                </option>
                                <option value="sort_number" <?php if(isset($_order) && $_order=='sort_number'): ?>selected<?php endif; ?>>
                                    排序
                                </option>
                                <option value="view_count" <?php if(isset($_order) && $_order=='view_count'): ?>selected<?php endif; ?>>
                                    浏览数
                                </option>
                                <option value="create_time" <?php if(isset($_order) && $_order=='create_time'): ?>selected<?php endif; ?>>
                                    发布时间
                                </option>
                            </select>
                        </div>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities((isset($item['user']['nickname']) && ($item['user']['nickname'] !== '')?$item['user']['nickname']:'')); ?></td>
                            <td><?php echo htmlentities((isset($item['article_category']['name']) && ($item['article_category']['name'] !== '')?$item['article_category']['name']:'')); ?></td>
                            <td>
                                <?php if(is_array($item['tag']) || $item['tag'] instanceof \think\Collection || $item['tag'] instanceof \think\Paginator): if( count($item['tag'])==0 ) : echo "" ;else: foreach($item['tag'] as $key=>$item_tag): ?>
                                <span class="label label-primary"><?php echo htmlentities($item_tag['name']); ?></span>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </td>
                            <td><?php echo htmlentities($item['is_top_text']); ?></td>
                            <td><?php echo htmlentities($item['is_hot_text']); ?></td>
                            <td><img style="max-width: 40px" src="<?php echo htmlentities($item['img']); ?>"></td>
                            <td><?php echo htmlentities($item['sort_number']); ?></td>
                            <td><?php echo htmlentities($item['view_count']); ?></td>
