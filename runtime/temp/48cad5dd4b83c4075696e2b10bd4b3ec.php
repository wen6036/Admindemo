<?php /*a:9:{s:77:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\staff\index.html";i:1567736791;s:77:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\base.html";i:1567736791;s:81:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\head_css.html";i:1567736791;s:80:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\head_js.html";i:1567736791;s:79:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\header.html";i:1567736791;s:80:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\sidebar.html";i:1567736791;s:87:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\content_header.html";i:1567736791;s:79:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\footer.html";i:1567736791;s:88:"D:\phpStudy\PHPTutorial\WWW\AdminDemo\application\admin\view\public\control_sidebar.html";i:1567736791;}*/ ?>
<?php if(!$admin['pjax']): ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<div class="row">
    ...
    <select name="_order" id="_order" class="form-control input-sm index-order">
        ...
        <option value="id" <?php if(isset($_order) && $_order=='id'): ?>selected<?php endif; ?>>ID</option>
<option value="job_number" <?php if(isset($_order) && $_order=='job_number'): ?>selected<?php endif; ?>>工号</option><option value="birthday" <?php if(isset($_order) && $_order=='birthday'): ?>selected<?php endif; ?>>生日</option><option value="hired_date" <?php if(isset($_order) && $_order=='hired_date'): ?>selected<?php endif; ?>>入职日期</option><option value="sort_number" <?php if(isset($_order) && $_order=='sort_number'): ?>selected<?php endif; ?>>排序</option><option value="status" <?php if(isset($_order) && $_order=='status'): ?>selected<?php endif; ?>>是否启用</option><option value="create_time" <?php if(isset($_order) && $_order=='create_time'): ?>selected<?php endif; ?>>创建时间</option>    </select>
</div>
...
<script>
    ...
    <i class="fa fa-trash"></i> 删除
                        ...
                        <a class="btn btn-success btn-sm AjaxButton" data-toggle="tooltip" title="启用选中数据" data-confirm-title="启用确认" data-confirm-content="您确定要启用选中的数据吗？" data-id="checked" data-url="<?php echo url('enable'); ?>">
    <i class="fa fa-circle"></i> 启用
</a>

<a class="btn btn-warning btn-sm AjaxButton" data-toggle="tooltip" title="禁用选中数据" data-confirm-title="禁用确认" data-confirm-content="您确定要禁用选中的数据吗？" data-id="checked" data-url="<?php echo url('disable'); ?>">
...
<th>创建时间</th>
                        ...
                        <tr>
                            <td>
    <input type="checkbox" onclick="checkThis(this)" name="data-checkbox" data-id="<?php echo htmlentities($item['id']); ?>" class="checkbox data-list-check" value="<?php echo htmlentities($item['id']); ?>" placeholder="选择/取消">
</td>
...
<td><?php echo htmlentities((isset($item['department']['name']) && ($item['department']['name'] !== '')?$item['department']['name']:'')); ?></td>
<td><?php echo htmlentities((isset($item['position']['name']) && ($item['position']['name'] !== '')?$item['position']['name']:'')); ?></td>
<td><?php echo htmlentities($item['job_number']); ?></td>
<td><?php echo htmlentities($item['mobile']); ?></td>
<td><?php echo htmlentities($item['email']); ?></td>
<td><?php echo htmlentities($item['birthday']); ?></td>
<td><?php echo htmlentities($item['hired_date']); ?></td>
<td><?php echo htmlentities($item['is_boss_text']); ?></td>
<td><?php echo htmlentities($item['is_leader_text']); ?></td>
...
<a class="btn btn-warning btn-xs AjaxButton" data-toggle="tooltip" title="禁用"  data-id="<?php echo htmlentities($item['id']); ?>" data-confirm-title="禁用确认" data-confirm-content='您确定要禁用ID为 <span class="text-red"><?php echo htmlentities($item['id']); ?></span> 的数据吗' data-url="<?php echo url('disable'); ?>">
    <i class="fa fa-circle"></i>
</a>
<?php else: ?>
<a class="btn btn-success btn-xs AjaxButton" data-toggle="tooltip" title="启用"  data-id="<?php echo htmlentities($item['id']); ?>" data-confirm-title="启用确认" data-confirm-content='您确定要启用ID为 <span class="text-red"><?php echo htmlentities($item['id']); ?></span> 的数据吗' data-url="<?php echo url('enable'); ?>">
    <i class="fa fa-circle"></i>
</a>
<?php endif; ?>
